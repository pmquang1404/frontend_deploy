...
// node_modules/@clerk/clerk-react/dist/chunk-M6Z36ACX.mjs
...
var useAuth = (initialAuthState = {}) => {
  ...
  const [authState, setAuthState] = (0, import_react9.useState)(() => {
  ...
  return useDerivedAuth({ sessionId, userId, actor, orgId, orgSlug, orgRole, getToken, signOut, has: has2 });
};
function useDerivedAuth(authObject) {
  const { sessionId, userId, actor, orgId, orgSlug, orgRole, has: has2, signOut, getToken } = authObject != null ? authObject : {};
...
// node_modules/@clerk/shared/dist/chunk-GFTLSM2T.mjs
...
// node_modules/@clerk/shared/dist/chunk-HMMF7KY5.mjs
...
var Portal = class extends import_react21.default.PureComponent {
  ...
  render() {
    ...
    return import_react21.default.createElement(import_react21.default.Fragment, null, !hideRootHtmlElement && import_react21.default.createElement("div", { ref: this.portalRef }), this.props.children);
  }
};
var CustomPortalsRenderer = (props) => {
  var _a, _b;
  return import_react21.default.createElement(import_react21.default.Fragment, null, (_a = props == null ? void 0 : props.customPagesPortals) == null ? void 0 : _a.map((portal, index) => (0, import_react21.createElement)(portal, { key: index })), (_b = props == null ? void 0 : props.customMenuItemsPortals) == null ? void 0 : _b.map((portal, index) => (0, import_react21.createElement)(portal, { key: index })));
};
...
var _UserProfile = withClerk(
  ({ clerk, ...props }) => {
    ...
    return import_react21.default.createElement(
      ...
      import_react21.default.createElement(CustomPortalsRenderer, { customPagesPortals })
    );
  },
  "UserProfile"
);
...
var UserButtonContext = (0, import_react21.createContext)({
  mount: () => {
  },
  unmount: () => {
  },
...
var _UserButton = withClerk(
  ({ clerk, ...props }) => {
    ...
    return import_react21.default.createElement(UserButtonContext.Provider, { value: passableProps }, import_react21.default.createElement(
      Portal,
      {
        ...passableProps,
      ...
      import_react21.default.createElement(CustomPortalsRenderer, { ...portalProps })
    ));
  },
  "UserButton"
);
...
function UserButtonOutlet(outletProps) {
  const providerProps = (0, import_react21.useContext)(UserButtonContext);
  const portalProps = {
    ...providerProps,
    props: {
      ...providerProps.props,
  ...
  return import_react21.default.createElement(Portal, { ...portalProps });
}
...
var OrganizationSwitcherContext = (0, import_react21.createContext)({
  mount: () => {
  },
  unmount: () => {
  },
...
var _OrganizationSwitcher = withClerk(
  ({ clerk, ...props }) => {
    ...
    return import_react21.default.createElement(OrganizationSwitcherContext.Provider, { value: passableProps }, import_react21.default.createElement(
      Portal,
      {
        ...passableProps,
        hideRootHtmlElement: !!props.__experimental_asProvider
...
function OrganizationSwitcherOutlet(outletProps) {
  const providerProps = (0, import_react21.useContext)(OrganizationSwitcherContext);
  const portalProps = {
    ...providerProps,
    props: {
      ...providerProps.props,
